...
@OCTAL@, @ALPHA_LOWER@, @ALPHA_UPPER@ and @ALPHA@. This means you can, out
...
code sample shows how you might use the library in a basic way:
	...
	pre. >>> from baseconv import \*
		 ...
		 >>> print num # Print a number as a string; also try str(num)
		 0x1A7
		 >>> num.values # The sequence of words that this number represents
		 '1A7'
